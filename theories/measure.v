...
(*                   numFieldType such that this function is non-negative     *)
(*                   over measurable sets, and is semi-additive               *)
...
(*                \d_a == Dirac measure                                       *)
(*           msum mu n == the measure corresponding to the sum of the         *)
(*                        measures mu_0,... , mu_{n-1}                        *)
...
(*                   numFieldType                                             *)
(*                                                                            *)
(*   mu.-cara.-measurable A == A is Caratheodory measurable for the outer     *)
(*                   measure mu, i.e.,                                        *)
...
(*                       - X `<=` \bigcup_k (F k)                             *)
(*               mu^* == extension of the measure mu over a semiring of sets; *)
(*                       it is an outer measure, declared as; we have the     *)
(*                       notation [the outer_measure of mu^*])                *)
(*                                                                            *)
(* * Hahn Extension:                                                          *)
...
Reserved Notation "d .-measurable" (at level 2, format "d .-measurable").
...
HB.structure Definition RingOfSets d :=
  {T of RingOfSets_from_semiRingOfSets d T &}.
...
Arguments measure_series {d T R}.
